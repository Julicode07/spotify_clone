  ...
  return (
    <div
      className={`
        ...
        overflow-hidden
      `}>
        <picture className="w-14 h-14 bg-zinc-800 rounded-md shadow-lg overflow-hidden m-2">
...
export function Player () {
  ...
  return (
    <div className="h-[70px] flex justify-between items-center">
      ...
      <div className="grid place-content-center gap-4 flex-1 w-[33%]">
      ...
      <div className="grid place-content-center w-[33%]">
        <VolumeControl />
      </div>
    </div>
  )
